<!-- ============================================================== -->
    ...
    <script>
        ...
        function validationRegex(a,b="alphanumeric",c=!1){b="alphanumeric"===b?/^[a-zA-Z0-9]+$/:"alphabet"===b?/^[a-zA-Z]+$/:"notzero"===b?/^[^0]+$/:"decimal"===b?/^[+-]?[0-9]+(?:\.[0-9]+)?$/:"numeric"===b?/^[0-9]+$/:"double"===b?/^[+-]?[0-9]+(?:,[0-9]+)*(?:\.[0-9]+)?$/:"username"===b?/^[a-zA-Z0-9]{3,20}$/:"email"===b?/^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/:b;var d="";return d=c?document.getElementById(a).value:a,!1!=b.test(d)}
