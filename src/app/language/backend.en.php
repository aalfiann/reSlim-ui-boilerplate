...
$vocabularies[] = [
    ...
    'val_wrong_format_domain' => 'Invalid domain format!',
    'val_wrong_format_date' => 'Invalid date format!',
    ...
    'helper_settings_api' => 'This will be used for this website system to work with rest api server.<br>Separate with commas if want to run multiple rest api.',
    'helper_settings_basepath' => 'Path must be full using http: or https:',
    'helper_settings_assetspath' => 'Path must be full using http: or https:',
    'helper_settings_fixedpath' => 'Path must be full using http: or https:.<br>Just leave blank if you don\'t run multiple reSlim rest api.',
    ...
    //pages meta
    'pages_meta_desc_latest' => 'The latest information of',
    'pages_meta_search' => 'Search result of keyword:',
    ...
    'input_assets_path' => 'Please input url assets folder of Your website...',
    'input_fixed_path' => 'Please input url main rest api of Your website...',
