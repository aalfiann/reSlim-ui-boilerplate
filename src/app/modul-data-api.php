...
<head>
    ...
    <title><?php echo Core::lang('api_keys')?> - <?php echo Core::getInstance()->title?></title>
</head>
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><?php echo Core::lang('api_keys')?></li>
                    </ol>
                </div>
                <div>
                    ...
                    <div class="col-md-12 col-12 align-self-center">
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                <button id="submitsearchdt" onclick="loadData('#dataapi','1',selectedOption(),document.getElementById('searchdt').value);" class="btn btn-themecolor" type="button"><?php echo Core::lang('search')?></button>
                            </span>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-40">
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title text-themecolor" id="myLargeModalLabel"><i class="mdi mdi-key-plus"></i> <?php echo Core::lang('add').' '.Core::lang('api_keys')?></h4>
                                                ...
                                                <form class="form-horizontal form-material" id="addnewdata" action="#">
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-12"><?php echo Core::lang('domain')?></label>
                                                             <div class="col-md-12">
                                                                <input id="domain" type="text" class="form-control form-control-line" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <table id="dataapi" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th><?php echo Core::lang('tb_no')?></th>
                                                <th><?php echo Core::lang('domain')?></th>
                                                <th><?php echo Core::lang('api_key')?></th>
    ...
    <script>
        ...
        function loadData(idtable,page="1",itemperpage="10",search=""){
            $(function() {
                ...
                var table = $(idtable).DataTable({
                    ajax: {
                        type: "GET",
                        url: "<?php echo Core::getInstance()->api.'/user/'.$datalogin['username'].'/keys/data/search/"+page+"/"+itemperpage+"/'.$datalogin['token'].'/?query="+encodeURIComponent(search)+"'?>",
                        cache: false,
                    ...
                    columns: [
                        ...
                        { "render": function(data,type,row,meta) { /* render event defines the markup of the cell text */ 
                                ...
                                var a = '<a href="#" data-toggle="modal" data-target=".'+row.ApiKey+'"><i class="mdi mdi-pencil-box-outline"></i> <?php echo Core::lang('edit')?></a>'; /* row object contains the row data */
                                a += '<!-- terms modal content -->\
                                    <div class="modal fade '+row.ApiKey+'" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">\
                                        <div class="modal-dialog modal-lg">\
                                            <div class="modal-content">\
                                                <div class="modal-header">\
                                                    <h4 class="modal-title text-themecolor" id="myLargeModalLabel"><i class="mdi mdi-key-plus"></i> <?php echo Core::lang('update').' '.Core::lang('api_keys')?></h4>\
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>\
                                                </div>\
                                                <form class="form-horizontal form-material" id="data'+row.ApiKey+'" action="<?php echo $_SERVER['PHP_SELF']?>">\
                                                    <div class="modal-body">\
                                                        <div class="form-group">\
                                                        ...
                                                        <div class="form-group">\
                                                            <label class="col-md-12"><?php echo Core::lang('domain')?></label>\
                                                             <div class="col-md-12">\
                                                                <input id="domain" type="text" class="form-control form-control-line" value="'+row.Domain+'" readonly>\
                                                            </div>\
                                                        </div>\
                                                        <div class="form-group">\
                                                            <label class="col-md-12"><?php echo Core::lang('api_key')?></label>\
                                                             <div class="col-md-12">\
                                                                <input id="apikey" type="text" class="form-control form-control-line" value="'+row.ApiKey+'" readonly>\
                                                            </div>\
                                                        </div>\
                                                        <div class="form-group">\
                                                    ...
                                                    <div class="modal-footer">\
                                                        ...
                                                        <div class="btn-toolbar justify-content-between" role="toolbar" aria-label="Toolbar with button groups">\
                                                            <div class="btn-group mr-2" role="group" aria-label="First group">\
                                                                <button id="deletebtn'+row.ApiKey+'" type="submit" onclick="deletedata(\''+row.ApiKey+'\');return false;" class="btn btn-danger"><?php echo Core::lang('delete')?></button>\
                                                            </div>\
                                                            <div class="btn-group mr-2" role="group" aria-label="Second group">\
                                                                <button type="button" class="btn btn-default waves-effect text-left mr-2" data-dismiss="modal"><?php echo Core::lang('cancel')?></button>\
                                                                <button id="updatebtn'+row.ApiKey+'" type="submit" onclick="updatedata(\''+row.ApiKey+'\');return false;" class="btn btn-success"><?php echo Core::lang('update')?></button>\
                                                            </div>\
                                                        </div>\
                                                        </div>\
                                                    </div>\
        ...
        function sendnewdata(e){
            ...
            disableClickButton(btn);
                $.ajax({
                    url: Crypto.decode("<?php echo base64_encode(Core::getInstance()->api.'/user/keys/create')?>"),
                    data : {
                    ...
                    success: function(data) {
                        ...
                        if (data.status == "success"){
                            div.innerHTML = messageHtml("success","<?php echo Core::lang('core_process_add').' '.Core::lang('api_keys').' '.Core::lang('status_success')?>");
                            /* clear from */
                            $("#addnewdata")
                            .find("input,textarea")
                            .val("")
                            ...
                            .prop("checked", "")
                            .end();
                            console.log("<?php echo Core::lang('core_process_add').' '.Core::lang('api_keys').' '.Core::lang('status_success')?>");
                            $('#dataapi').DataTable().ajax.reload(); /* reload data table */
                            that.on("submit", sendnewdata); /* add handler back after ajax */
                        } else {
                            div.innerHTML = messageHtml("danger","<?php echo Core::lang('core_process_add').' '.Core::lang('api_keys').' '.Core::lang('status_failed')?>",data.message);
                            that.on("submit", sendnewdata); /* add handler back after ajax */
                        }
                    },
                    complete: function(){
        ...
        function updatedata(dataid){
            $(function() {
                ...
                disableClickButton(btn);
                $.ajax({
                    url: Crypto.decode("<?php echo base64_encode(Core::getInstance()->api.'/user/keys/update')?>"),
                    data : {
                        Username: "<?php echo $datalogin['username']?>",
                        Token: "<?php echo $datalogin['token']?>",
                        ApiKey: dataid,
                    ...
                    success: function(data) {
                        div.innerHTML = "";
                        if (data.status == "success"){
                            div.innerHTML = messageHtml("success","<?php echo Core::lang('core_process_update').' '.Core::lang('api_keys').' '.Core::lang('status_success')?>");
                            console.log("<?php echo Core::lang('core_process_update').' '.Core::lang('api_keys').' '.Core::lang('status_success')?>");
                            $('#dataapi').DataTable().ajax.reload(); /* reload data table */
                            $('.'+dataid).modal('hide');
                        } else {
                            div.innerHTML = messageHtml("danger","<?php echo Core::lang('core_process_update').' '.Core::lang('api_keys').' '.Core::lang('status_failed')?>",data.message);
                            $('.'+dataid).modal('hide');
                        }
                    },
                    complete: function(){
        ...
        function deletedata(dataid){
            $(function() {
                ...
                disableClickButton(btn);
                $.ajax({
                    url: Crypto.decode("<?php echo base64_encode(Core::getInstance()->api.'/user/keys/delete')?>"),
                    data : {
                        Username: "<?php echo $datalogin['username']?>",
                        Token: "<?php echo $datalogin['token']?>",
                        ApiKey: dataid
                    ...
                    success: function(data) {
                        div.innerHTML = "";
                        if (data.status == "success"){
                            div.innerHTML = messageHtml("success","<?php echo Core::lang('core_process_delete').' '.Core::lang('api_keys').' '.Core::lang('status_success')?>");
                            console.log("<?php echo Core::lang('core_process_delete').' '.Core::lang('api_keys').' '.Core::lang('status_success')?>");
                            $('#dataapi').DataTable().ajax.reload(); /* reload data table */
                            $('.'+dataid).modal('hide');
                        } else {
                            div.innerHTML = messageHtml("danger","<?php echo Core::lang('core_process_delete').' '.Core::lang('api_keys').' '.Core::lang('status_failed')?>",data.message);
                            $('.'+dataid).modal('hide');
                        }
                    },
                    complete: function(){
